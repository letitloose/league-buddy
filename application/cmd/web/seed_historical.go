...
// seasons, 34 matches, 17 opponent teams) provided by the site owner, so the
...
// more formal names the source spreadsheet used for historical results —
// per the site owner, "Fulmont FC" and "Grassmonkey FC" are the same teams
// that appear in historical results as "GSL FC - Active Ingredient Brewing
// Co" and "Crazy Dawg T Shirts" under earlier names, not new teams.
var historicalOpponentTeams = []string{
	...
	"Knick91SC",
	"Legends",
	// Resurgence FC, Rotterdam, and Troy United FC are deliberately not
	// listed here — migration 0013 creates them (needed in prod, where
	// this seed file never runs), and duplicating that here would give
	// this dev DB two teams of the same name.
}
...
// setup.sql already seeded for Colonial FC's current home field (100
// Phillips Rd) — LocationService.CreateLocation dedupes on address, so this
// resolves to that same existing location rather than creating a
// duplicate. Its Name field below is never actually used on a dedupe hit
// (migration 0014 already renamed that row to "East Greenbush"), but is
// kept in sync with it for anyone reading this list, not because it does
// anything at runtime.
var historicalLocationDefs = []historicalLocation{
	...
	{"eastgreenbush", "East Greenbush", "100 Phillips Rd", "East Greenbush", "NY", ""},
}
...
var historicalMatches = []historicalMatch{
	...
	{"spring2024", "2024-06-02", "Colonial FC", "Fulmont FC", "clifton", nil, nil, "Colonial FC won (score not recorded)"},
	{"spring2024", "2024-06-09", "Colonial FC", "Corona FC", "clifton", nil, nil, "Colonial FC lost (score not recorded)"},
	{"spring2024", "2024-06-16", "Guilderland FC", "Colonial FC", "nott", nil, nil, "Colonial FC won (score not recorded)"},
	...
	// Fall 2024
	{"fall2024", "2024-09-08", "Chatham", "Colonial FC", "crellin", intp(1), intp(3), ""},
	...
	{"fall2024", "2024-09-29", "Fulmont FC", "Colonial FC", "gloversville", intp(4), intp(3), ""},
	...
	{"spring2025", "2025-06-15", "Guilderland FC", "Colonial FC", "nott", intp(2), intp(5), ""},
	{"spring2025", "2025-06-22", "Colonial FC", "Grassmonkey FC", "clifton", intp(9), intp(2), ""},
	{"spring2025", "2025-06-29", "Greene FC", "Colonial FC", "eastgreenbush", intp(2), intp(5), ""},
	...
	{"fall2025", "2025-09-21", "Chatham", "Colonial FC", "crellin", intp(5), intp(6), ""},
	{"fall2025", "2025-09-28", "Fulmont FC", "Colonial FC", "gloversville", intp(7), intp(1), ""},
	{"fall2025", "2025-10-05", "Bethlehem FC", "Colonial FC", "nott", nil, nil, "Result not recorded"},
	{"fall2025", "2025-10-19", "Colonial FC", "Atletico FC", "malwyck", nil, nil, "Result not recorded"},
	...
	{"spring2026", "2026-06-14", "Colonial FC", "Fulmont FC", "eastgreenbush", intp(4), intp(2), "GSL only had 8 players but we loaned them some"},
